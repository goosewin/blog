...
**Technology was created to accelerate and connect humans, regardless of their abilities and limitations. It is therefore imperative that I use it to empower individuals and communities, rather than to exploit them.**

Every initiative, every feature, every decision has to pass this principle. If it doesn't pass, then it's noise.
...
We don't have to accept an internet that enriches a few while hollowing out human attention. We can build, and choos, systems that compound agency.

The stakes are too high to optimize for the wrong things.

---

_Building tools that accelerate humans? DM me on [X/Twitter @dan_goosewin](https://x.com/dan_goosewin)._
