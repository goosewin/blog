...
export const metadata = {
   ...
   date: '2025-10-20',
   description: 'Tech should compound human agency and progress, not harvest attention for ad markets. How we got here and how to fix it.',
   image: '/images/screen-time-by-age.png',
};

<Image src="/images/screen-time-by-age.png" alt="Attention span distribution by age, September 2025" width={1440} height={1094} />
...
_Building tools that accelerate humans? [DM me on X/Twitter](https://x.com/goosewin)._
