...
export const metadata: Metadata = {
  title: 'Contact',
  description:
    'Connect with Daniel Stolbov for collaboration opportunities, technology leadership insights, or discussions on building innovative digital experiences and enterprises.',
};
